<?php
/*
 * Template Name: Real Estate Development
 */
get_header(); ?>
      ...
      <div class="sd-content-wrapper">
        <div class="sd-layout">
          ...
          <div class="sd-left">
            <img class="sd-main-img"
                 src="<?php echo get_template_directory_uri(); ?>/images/services/real-estate-banner.jpg"
                 alt="Real Estate Development" />

            <h2 class="sd-section-title">About the service</h2>
            <p class="sd-body-text">Our real estate services are designed to make buying, selling, or investing in 
                property a smooth and stress-free experience. Whether you're searching for your dream home, a commercial 
                space, or a high-return investment, we provide expert guidance at every step. From market research and 
                property selection to negotiations and final documentation, our team ensures transparency, efficiency, and 
                the best possible value for your investment.</p>
            <p class="sd-body-text">We focus on understanding your unique needs and delivering tailored solutions that 
                align with your goals. With a strong network, in-depth market knowledge, and a commitment to excellence, 
                we help clients make confident decisions in a competitive real estate landscape. Our approach combines 
                professionalism with personalized support, ensuring that every transaction is handled with care, precision, 
                and long-term value in mind.</p>    

            <!-- Why choose us — same as general template -->
            <div class="sd-why-section">
              <h2 class="sd-section-title">Why choose us</h2>
              <p class="sd-body-text">Choose us for our trusted expertise, transparent process, and commitment to 
                delivering the best value tailored to your real estate goals.</p>
            ...
            <div class="sd-offered-layout">
              ...
              <img class="sd-offered-img"
                   src="<?php echo get_template_directory_uri(); ?>/images/services/real-estate-banner2.jpg"
