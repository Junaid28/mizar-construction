        ...
        <div class="sd-layout">
          ...
          <div class="sd-left">
            <img class="sd-main-img"
                 src="<?php echo get_template_directory_uri(); ?>/images/services/project-management-banner.jpg"
                 alt="Project Management" />

            <h2 class="sd-section-title">About the service</h2>
            <p class="sd-body-text">Our project management services are designed to ensure the successful delivery of your construction projects on time, within budget, and to the highest quality standards. Whether you're managing a residential development, commercial building, or infrastructure project, we provide comprehensive oversight and strategic guidance at every stage. From initial planning and resource allocation to execution and final handover, our team ensures seamless coordination and effective problem-solving.</p>
            <p class="sd-body-text">We focus on understanding your unique needs and delivering tailored solutions that align with your goals. With a strong network, in-depth market knowledge, and a commitment to excellence, we help clients make confident decisions in a competitive real estate landscape. Our approach combines
            ...
            <div class="sd-offered-layout">
              ...
              <img class="sd-offered-img"
                   src="<?php echo get_template_directory_uri(); ?>/images/services/Project-Management-footer-banner.jpg"
