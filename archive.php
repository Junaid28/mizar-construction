        ...
        <div class="blog-grid" id="blogGrid">
          ...
          if ( $blog_query->have_posts() ) :
            while ( $blog_query->have_posts() ) : $blog_query->the_post();
              ...
              // Get first category slug for filter
              ...
              if ( has_post_thumbnail() ) {
                ...
                $img_url = get_template_directory_uri() . '/images/blog/blog-placeholder.jpg';
              }
          ?>
          ...
          <?php
            ...
            <p style="padding: 40px; color: rgba(26,26,46,0.6);">No blog posts found.</p>
          <?php endif; ?>
